...
To download the latest source from OpenCV's GitHub Repository or from https://github.com/RtjShreyD/opencv . (If you want to contribute to OpenCV choose this. For that, you need to install Git first)
$ sudo apt-get install git
$ git clone https://github.com/opencv/opencv.git    OR $ git clone https://github.com/RtjShreyD/opencv.git
